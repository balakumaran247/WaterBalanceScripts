...
import os
import sys
sys.path.append(r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\scripts")
import pandas as pd
...
#%%
wp_folder=r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Netcdf_files"#folder with nc files from water balance model
BASIN={
       'name': 'Menagagi',
       'hydroyear':'A-MAY', #Water year end month
       'chunksize':None,
       'unit_conversion':1e6, #1e3 for input data in MCM, 1e6 for input data in km3
       'output_folder':r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Netcdf_files\hydroloop_results",
       'gis_data':{
               'basin_mask': r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\Menasagi.tif",
               'subbasin_mask':{
                       1: r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\1_subbasin.tif",
                       2: r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\2_subbasin.tif"
                       },
               'dem':None,
               'aeisw':r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\gmia_v5_aeisw_pct_aei.tif", #area equipped with surface water irrigation percentage
               'population':r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\Pop_Menasagi.tif",
               },
       'data_cube':{
           'monthly':{
               'p':os.path.join(wp_folder,
                                          'Menasagi_P_CHIRPS.nc'),
                'etref':os.path.join(wp_folder,
                                          'Menasagi_ETref_WA.nc'),
               'et':os.path.join(wp_folder,
                                          'Menasagi_ETa_SSEBop.nc'),
               ...
               'lai':os.path.join(wp_folder,
                                          'Menasagi_LAI_MOD15.nc'),
              'ndm':os.path.join(wp_folder,
                                          'Menasagi_DMP_ProbaV.nc'),
        ...
        'params':{
            'crops':{#lu_code: [r'seasons_dates.csv','Crop_type']
                    35.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_Kharif.csv",'N/A'],
                    54.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_Kharif.csv",'N/A'],
                    36.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_Rabi.csv",'N/A'],
                    55.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_Rabi.csv",'N/A'],
                    37.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_Zaid.csv",'N/A'],
                    56.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_Zaid.csv",'N/A'],
                    57.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_double_triple.csv",'N/A'],
                    33.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_plantation.csv",'N/A'],                    
                    52.0: [r"C:\bhargavi\ACIWRM\Water Accounting\WAPlus_Sashi\2020_training\day1\Menasagi\Additional_data\crop_season\seasons_plantation.csv",'N/A'],                      
                    },
            'dico_in':{1:[], 2:[1]},
            'dico_out':{1:[2], 2:[0]},
...
for sheet5_csv in sheet5_yearly_csvs:
    ...
    ps.print_sheet5(BASIN['name'],sb_codes=[1,2], dico_in=BASIN['params']['dico_in'], dico_out=BASIN['params']['dico_out'],
